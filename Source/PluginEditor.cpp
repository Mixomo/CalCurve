...
namespace
{
    ...
    juce::String helpText()
    {
        return
            ...
            "CalCurve is intentionally narrow: it does not include a headphone database, headphone simulation, or target selection. The loaded file is assumed to already be an exported/calibrated correction curve.\n\n"
            "Supported imports\n\n"
            ...
            "- DAW project state stores the same core data, so sessions can restore the loaded curve even when the original file is unavailable.\n\n"
            "Graph\n\n"
            ...
            "- At 0% Dry/Wet the line becomes flat. At 100% Dry/Wet it shows the full correction.\n\n"
